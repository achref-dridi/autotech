...
<html lang="fr">
  <head>
    ...
    <title>Tableau de Bord AutoTech</title>
    <meta
        ...
        <div class="sidebar-logo">
          ...
          <div class="logo-header" data-background-color="dark">
            <a href="index.html" class="logo">
              <img
                src="assets/img/kaiadmin/off_logo.png"
                alt="navbar brand"
                class="navbar-brand"
                height="20"
              />
                        ...
                        <div class="notif-center">
                          ...
                          <a href="#">
                            ...
                            <div class="notif-content">
                              ...
                              <span class="block"> OK, Merci ! </span>
                          ...
                          <a href="#">
                            ...
                            <div class="notif-content">
                              ...
                              <span class="block">
                                Prêt pour la réunion aujourd'hui...
                              </span>
                              <span class="time">Il y a 12 minutes</span>
                            </div>
                          </a>
                          <a href="#">
                            ...
                            <div class="notif-content">
                              ...
                              <span class="block"> Salut, Comment ça va ? </span>
                      ...
                      <div class="notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          ...
                          <a href="#">
                            ...
                            <div class="notif-content">
                              <span class="block"> Farrah a apprécié Admin </span>
                              <span class="time">Il y a 17 minutes</span>
                            </div>
                          </a>
                        </div>
          ...
          <div class="page-inner">
            ...
            >
              <div>
                ...
                <h6 class="op-7 mb-2">Tableau de Bord Admin Bootstrap 5 Gratuit</h6>
              </div>
              <div class="ms-md-auto py-2 py-md-0">
                <a href="#" class="btn btn-label-info btn-round me-2">Gérer</a>
                <a href="#" class="btn btn-primary btn-round">Ajouter Client</a>
              </div>
            </div>
            <div class="row">
            <!-- Carte Voitures -->
      ...
      <div class="card-body">
        <div class="row align-items-center">
          ...
          <div class="col col-stats ms-3 ms-sm-0">
            <div class="numbers">
              <p class="card-category">Voitures</p>
              <h4 class="card-title"><?= $nbVehicules ?></h4>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="card card-primary card-round">
                  <div class="card-header">
                    <div class="card-head-row">
                      <div class="card-title">Ventes Quotidiennes</div>
                      <div class="card-tools">
                        <div class="dropdown">
                          <button
                    ...
                    <div class="card-category">25 Mars - 02 Avril</div>
                  </div>
                ...
                <div class="card card-round">
                  <div class="card-body pb-0">
                    ...
                    <h2 class="mb-2">17</h2>
                    <p class="text-muted">Utilisateurs en ligne</p>
                ...
                <div class="card card-round">
                  <div class="card-header">
                    <div class="card-head-row card-tools-still-right">
                      <h4 class="card-title">Géolocalisation Utilisateurs</h4>
                      <div class="card-tools">
                        <button
                    ...
                    <p class="card-category">
                      Carte de la distribution des utilisateurs dans le monde
                    </p>
                  </div>
                  <div class="card-body">
                    <div class="row">
                    ...
                    <div class="card-list py-4">
                      <div class="item-list">
                        ...
                        <div class="info-user ms-3">
                          ...
                          <div class="status">Graphiste</div>
                        </div>
                      ...
                      <div class="item-list">
                        ...
                        <div class="info-user ms-3">
                          ...
                          <div class="status">Promotion des Ventes</div>
                        </div>
                        <button class="btn btn-icon btn-link op-8 me-1">
                          <i class="far fa-envelope"></i>
                        </button>
                      ...
                      <div class="item-list">
                        ...
                        <div class="info-user ms-3">
                          ...
                          <div class="status">Designer Front End</div>
                        </div>
                        <button class="btn btn-icon btn-link op-8 me-1">
                          <i class="far fa-envelope"></i>
                        </button>
                      ...
                      <div class="item-list">
                        ...
                        <div class="info-user ms-3">
                          ...
                          <div class="status">Designer Web</div>
                        </div>
                        <button class="btn btn-icon btn-link op-8 me-1">
                          <i class="far fa-envelope"></i>
                        </button>
                      ...
                      <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td class="text-end">19 Mars 2020, 14h45</td>
        ...
        <footer class="footer">
          <div class="container-fluid d-flex justify-content-between">
            ...
            <div class="copyright">
              2024, réalisé avec <i class="fa fa-heart heart text-danger"></i> par
