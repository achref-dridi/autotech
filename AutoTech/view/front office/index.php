...
// On limite par exemple aux 8 premiers véhicules à afficher
...
<body data-theme="dark">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.html"><img src="images/off_logo.png" alt="logo.png" id="img_logo"></a>
        ...
        <div class="car-wrap rounded ftco-animate">
          ...
          <div class="img rounded d-flex align-items-end"
               style="background-image: url('<?php
                   if (!empty($v["image_principale"])) {
                       // URL relative depuis /view/front office/index.php vers /uploads

                       
                       echo "../../uploads/" . htmlspecialchars($v["image_principale"]);
                   } else {
                       // image par défaut si pas de photo en BDD
                       echo "images/car-1.jpg";
                   }
               ?>');">
          </div>
          <div class="text">
            ...
            <div class="d-flex mb-3">
              ...
              <p class="price ml-auto">
                <!-- ici tu mets ce que tu veux afficher : prix, km, etc. -->
...
<a href="#" class="btn btn-primary py-2 mr-1">
    Réserver
</a>           <a href="car-single.php?id=<?= $v['id_vehicule'] ?>"
      ...
      <div class="row no-gutters">
        ...
        <div class="col-md-6 wrap-about ftco-animate">
          <div class="heading-section heading-section-white pl-md-5">
            ...
            <p>Notre plateforme automobile a été développée avec un objectif clair : révolutionner la manière dont les utilisateurs interagissent avec le marché automobile.
Que ce soit pour acheter, louer ou publier une offre, tout devient plus intuitif et accessible.</p>
...
✔️ des conducteurs qui proposent des services de déplacement (système type taxi). <br>
              ...
              <div class="testimony-wrap rounded text-center py-4 pb-5">
                ...
                <div class="text pt-4">
                  <p class="mb-4">Loin là-bas, derrière les montagnes de mots, loin des pays Vokalia et
                    Consonantia, vivent les textes aveugles.</p>
                  <p class="name">Roger Scott</p>
                  <span class="position">Analyste Système</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="block-23 mb-3">
              <ul>
                ...
                <li><a href="#"><span class="icon icon-envelope"></span><span
                      class="text">AutoTech@gmail.tn</span></a></li>
              </ul>
            </div>
          </div>
        </div>
